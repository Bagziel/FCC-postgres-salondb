...
echo -e "\n~~~~~ COMFI SALON ~~~~~\n"
echo -e "Welcome to COMFI Salon, how can I help you?\n"
...
GET_RESERVE() {
  ...
  read SERVICE_TIME
  RESERVED_TO_TABLE_APPOINTMENTS=$($PSQL "INSERT INTO appointments(customer_id, service_id, time) VALUES($CUSTOMER_ID, $SERVICE_ID_SELECTED, '$SERVICE_TIME')")
  if [[ $RESERVED_TO_TABLE_APPOINTMENTS == "INSERT 0 1" ]]
  then
